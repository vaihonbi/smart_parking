...
Route.group(() => {
  ...
  Route.get("/session", "SessionController.getAll");
})
  .prefix("/api")
  .namespace("Api")
  .middleware(["auth:jwt"]);
...
Route.group(() => {
  ...
  Route.get("/change_password", "ChangePasswordController.changePassword").as(
    "changepassword"
  );
  Route.post("/change_password", "ChangePasswordController.phoneNumber").as(
    "changepassword"
  );
  Route.post("/verify_otp", "ChangePasswordController.verifyOtp").as(
    "verifyOtp"
  );
  Route.post("/new_password", "ChangePasswordController.newPassword").as(
    "newPassword"
  );
